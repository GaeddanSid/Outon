...
function Productcarousel({ onProductClick }) {
    ...
    return (_jsxs("div", Object.assign({ className: "carousel-2" }, { children: [_jsx("div", Object.assign({ className: "the-rio-rush" }, { children: "SEE THE WORLD THROUGH OUR GLASSES" })), _jsx(Carousel, Object.assign({ interval: null, slide: true, indicators: false }, { children: Array.from({ length: Math.ceil(products.length / 4) }).map((_, index) => (_jsx(Carousel.Item, { children: _jsx("div", Object.assign({ className: "d-flex w-100" }, { children: getFourRandomProducts().map((product) => (_jsx("div", Object.assign({ className: "product-item", onClick: () => onProductClick(product) }, { children: _jsxs(Link, Object.assign({ to: `/Product-details/${product.id}#top` }, { children: [_jsx("img", { className: "d-block hover-effect", src: getImagePath(product.image), alt: product.name }), _jsxs("div", Object.assign({ className: "product-info" }, { children: [_jsx("h3", { children: product.name }), _jsx("p", Object.assign({ className: "product-text" }, { children: product.color })), _jsxs("p", Object.assign({ className: "product-text" }, { children: [_jsx("strong", { children: "$" }), product.price] }))] }))] }), product.id) }), product.id))) })) }, index))) })), _jsx(Link, Object.assign({ to: "/All-sunglasses" }, { children: _jsx("button", Object.assign({ className: "find" }, { children: "Shop the collection" })) }))] })));
}
